...
class LetvSpider(object):
    ...
    COMMENT_URL = 'http://api.my.le.com/vcm/api/list?jsonp=jQuery19106596654532269319_1575164258089&type=video' \
                  '&rows=20&page=1&sort=&cid=1&source=1&xid={xid}&pid={pid}&ctype=cmt%2Cimg%2Cvote' \
                  '&listType=1&_=1575164258095'
    ...
    HEADERS = {
        ...
        'Cookie': 'tj_lc = 32696bb81587f2e7258c350f8518994e; tj_uuid = -_15751637970179369968;tj_env = 1; '
                  'ark_uuid = ck-d3092f27-687d-457f-b1c6-ba3ac90877c4-1201-092959;'
                  'bd_xid = 32696bb81587f2e7258c350f8518994e; ssoCookieSynced = 1; language = zh-cn; '
                  'sso_curr_country = CN; tj_v2c = -26680567_1',
        'Host': 'api.my.le.com',
